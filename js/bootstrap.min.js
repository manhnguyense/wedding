        ...
        return (
          ...
          (a._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (!e && n.toggle && /show|hide/.test(i) && (n.toggle = !1), e || ((e = new a(this, n)), t.data(nt, e)), 'string' == typeof i)
              ) {
    ...
    Sn =
      ...
      (Qt = (function () {
        ...
        return (
          ...
          (t._getConfig = function (t) {
            return (
              (t = h({}, this.constructor.Default, mt(this._element).data(), t)), Cn.typeCheckConfig(pt, t, this.constructor.DefaultType), t
            );
          }),
          ...
          (l._dataApiKeydownHandler = function (t) {
            if (
              (/input|textarea/i.test(t.target.tagName)
                ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || mt(t.target).closest(Lt).length)))
                : Ct.test(t.which)) &&
        ...
        return (
          ...
          (t.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              var s =
                  'function' == typeof this.config.placement ? this.config.placement.call(this, i, this.element) : this.config.placement,
          ...
          (t._fixTransition = function () {
            ...
            null === t.getAttribute('x-placement') &&
              (oe(t).removeClass(Ee), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
          }),
          (i._jQueryInterface = function (n) {
            return this.each(function () {
      ...
      (Tn = (function () {
        ...
        return (
          (t.show = function () {
            ...
            if (
              !(
                (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && rn(this._element).hasClass(cn)) ||
